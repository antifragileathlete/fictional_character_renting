...
Wanna party all night long, hang out late at night in places where you normally would not dare to walk alone? Then go ahead and book a day and or night with Ms Romanova.", price: 120, user_id: 1)
...
If you are currently at war, plan to go to war or just want to head out and fight some bad guys you want to have Itachi as your bodyguard.", price: 150, user_id: 1)
...
character = Character.new(name: "Link", genre: "Gaming", description: "Link is the name of various young men who characteristically wear a green tunic and a pointed cap, and are the bearers of the Triforce of Courage. This means that whoever turns out to be link is totally random! All is known is that it will be a young men. Will he be tall, short, thick, slim? Who knows. All you know is that you will get someone with courage and charisma- Also, he will be able to handle shield bow and sword no problem. Need a wolf at your side? Link can shapeshift, remember Game of Thrones? Exactly. Go right ahead and join Link for a unique experience and let yourself be surprised as to who this Link will be.", price: 30, user_id: 1)
...
character = Character.new(name: "Batman", genre: "Superhero", description: "Batman lives and works in Gotham City. Unlike most superheroes, Batman does not possess any inhuman superpowers. He does, however, possess a genius-level intellect and is a peerless martial artist, and his vast wealth affords him an extraordinary arsenal of weaponry and equipment.
Therefore, challenging your argumentation skills, finishing your dissertation or just showing off with a very smart companion on your side, you will want to book some time with Batman. If you live far away from Gotham, don't worry, Batman has a jetplane and a supercar to come to you and if he really likes you, he may take you with him, no promises though, that is up to him.", price: 10, user_id: 1)
